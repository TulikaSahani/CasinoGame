...
public class DatePickerWrapper : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            dateInputField.onValueChanged.AddListener(OnInputFieldChanged);
        }
    }
    void OnInputFieldChanged(string newValue)
    {
        // When user types directly into the input field
